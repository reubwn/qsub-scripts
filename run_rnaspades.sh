...
## define files
READS1=~/data/ricciae/filtered/rna-seq/Aricci-RNA_1.trimmed.ecc.fq.gz
READS2=~/data/ricciae/filtered/rna-seq/Aricci-RNA_2.trimmed.ecc.fq.gz
SUFFUX=transcriptome
