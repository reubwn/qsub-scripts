...
LIBRARY=library_file.gapfiller.txt
FASTA=
OUTDIR=gapfiller_I

perl ~/software/GapFiller_v1-10_linux-x86_64/GapFiller.pl \
-l ${LIBRARY} \
-s ${FASTA} \
-i 6 \
-T 16 \
...
## cleanup
rm -r ${OUTDIR}/alignoutput/ ${OUTDIR}/intermediate_results/ ${OUTDIR}/reads/
