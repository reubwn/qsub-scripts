...
##
module load blast+/2.2.28 hmmer/3.1

## load variables
export WISECONFIGDIR=/home/rnowell/software/wise2.4.1/src/../wisecfg/
export PERL5LIB=/home/rnowell/software/cegma-2.5/lib/:${PERL5LIB}

## define genome
GENOME=
CEGMA_PREFIX=`echo ${GENOME} | sed 's/\..*//'`

/home/rnowell/software/cegma-2.5/bin/cegma \
--genome ${GENOME} \
--threads 16 \
--output ${CEGMA_PREFIX}
