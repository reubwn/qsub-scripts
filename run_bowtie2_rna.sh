...
-2 $READS2 \
| samtools view -@ 64 -b - \
| samtools sort -@ 64 -no - - > ${PREFIX}.bowtie2.nameSorted.bam

## Trinity alignment stats
/home/rnowell/software/trinityrnaseq-2.2.0/util/SAM_nameSorted_to_uniq_count_stats.pl ${PREFIX}.bowtie2.nameSorted.bam > ${PREFIX}.bowtie2.nameSorted.bam.trinity_stats.txt
