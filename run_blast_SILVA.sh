...
QUERY=
PREFIX=
DB=~/ncbi/db/rnacentral_active.SILVA.rDNA.fasta
...
-out ${PREFIX}.vs.SILVA.dcmegablast.1e25.out

## taxify its ass
source ~/virt_env/python/blobtools/bin/activate
blobtools taxify -b ${PREFIX}.vs.SILVA.dcmegablast.1e25.out -r ~/ncbi/db/id_mapping.SILVA.tsv
